...
public:
    ...
    Vector(const Eigen::Vector3d& vec) : data_(vec) {}

    inline Eigen::Vector3d mat() const { return data_; }
    ...
    inline Vector& operator+=(const Vector& other) { data_ += other.data_; return *this; }
    inline Vector& operator-=(const Vector& other) { data_ -= other.data_; return *this; }
    inline Vector& operator*=(double scalar) { data_ *= scalar; return *this; }
    inline Vector& operator/=(double scalar) { data_ /= scalar; return *this; }
